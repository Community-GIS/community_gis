...
try:
    from community_gis.local_settings import *
...
SITENAME = os.getenv("SITENAME", 'community_gis')
...
if PROJECT_NAME not in INSTALLED_APPS:
    INSTALLED_APPS += (PROJECT_NAME,'dashboard','school_gis', 'fgis_map.apps.FgisMapConfig',)
